...
exports.updateUploadImage = function(req, img,done){
    var username = req.cookies.username;
    var image = img;
    g.accountManager.updateUploadImage(username, image);
}
exports.getUserImages = function(req, done){
    var username = req.cookies.username;
    var images = g.accountManager.getUserImages(username);
    images.toArray(function(err,result){
        console.log(result);
    });
    return images;
}
exports.addImage = function(req,img,title,desc,done){
    var username = req.cookies.username;
    g.accountManager.addImage(username,img,title,desc);
}
